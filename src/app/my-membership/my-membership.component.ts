...
export class MyMembershipComponent implements OnInit {
  ...
  navLinks = [
    { path: '/my-membership/active-memberships', label: 'Active Memberships' },
    { path: '/my-membership/billing-history', label: 'Billing History' },
    { path: '/my-membership/payment-methods', label: 'Payment Methods' }
  ]
